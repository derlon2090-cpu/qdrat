    ...
    <div dir="rtl" className="space-y-6">
      <div className="rounded-[1.9rem] border border-[#E8D8B3] bg-white/95 p-6 shadow-soft">
        ...
        <p className="mt-2 max-w-3xl text-sm leading-8 text-slate-600">
          صار التصنيف يعتمد على المطلوب من السؤال نفسه: فهم المقروء، المفردات، الدلالة اللغوية، تصنيف النص،
          التناظر اللفظي، إكمال الجمل، الخطأ السياقي، والمفردة الشاذة. أما القطع اللفظية نفسها فلها مسار مستقل
          يعرض النص مع أسئلته.
        </p>
        ...
        <div className="mt-5 rounded-[1.6rem] border border-[#E8D8B3] bg-[#fffaf1] p-5">
          ...
          <div className="mt-3 grid gap-3 md:grid-cols-2 xl:grid-cols-3">
            {[
              { label: "فهم المقروء", hint: "يفهم من النص / نستنتج / عنوان مناسب / الفكرة العامة" },
              { label: "المفردات", hint: "معنى كلمة / مرادف / ضد / المقصود بـ" },
              { label: "الدلالة اللغوية", hint: "تفيد / تدل / الضمير / العلاقة بين / نوع الأسلوب" },
              { label: "تصنيف النص", hint: "نوع النص / حكمة / نصيحة / مقالة / القالب الفني" },
