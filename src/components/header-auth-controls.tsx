    ...
    return (
      <div className={containerClass} dir="ltr">
        <button
          type="button"
          onClick={handleLogout}
          className="hidden h-[50px] items-center gap-2.5 rounded-[1.05rem] border border-[#e6edf9] bg-white px-5 text-[0.92rem] font-bold text-slate-700 shadow-[0_10px_22px_rgba(15,23,42,0.045)] transition hover:border-rose-200 hover:text-rose-600 xl:inline-flex"
        >
          <LogOut className="h-4 w-4" />
          {LOGOUT_LABEL}
        </button>

        <div className="flex h-[50px] items-center gap-2.5 rounded-[1.05rem] border border-[#e6edf9] bg-white px-3 shadow-[0_10px_22px_rgba(15,23,42,0.045)] xl:h-[52px] xl:gap-3 xl:px-4">
