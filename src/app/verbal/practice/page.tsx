...
export default function VerbalPracticePage() {
  return (
    <PageShell
      ...
      description="ابدأ من تناظر لفظي أو إكمال الجمل أو الخطأ السياقي أو المفردة الشاذة. كل سؤال مرتبط بتصحيح بعد التأكيد وشرح للإجابة الصحيحة مع دعم حفظ الأخطاء."
      icon={BookOpenText}
      iconWrap="bg-[#eef4ff]"
