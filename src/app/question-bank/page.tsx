...
export default function QuestionBankPage() {
  return (
    <PageShell
      ...
      description="القطع اللفظية لها قسم مستقل تظهر فيه القطعة نفسها مع أسئلتها، وباقي الأسئلة اللفظية صارت مرتبة داخل تناظر لفظي، إكمال الجمل، الخطأ السياقي، والمفردة الشاذة مع تصحيح وشرح بعد التأكيد."
