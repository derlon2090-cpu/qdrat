...
export default function QuestionBankPage() {
  return (
    <PageShell
      ...
      description="القطع اللفظية تعمل بالبحث بالكلمات المفتاحية، والأسئلة اللفظية المتنوعة صارت مرتبة داخل تناظر لفظي، إكمال الجمل، الخطأ السياقي، المفردة الشاذة، والفهم القصير مع تصحيح وشرح بعد التأكيد."
